...
var _udn="getfirefox.jp";		// (auto|none|domain) set the domain name for cookies
var _uhash="on";		// (on|off) unique domain hash for cookies
var _utimeout="1800";   	// set the inactive session timeout in seconds
var _ugifpath="/video/wp-content/themes/videoawards/img/__utm.gif";	// set the web path to the __utm.gif file
